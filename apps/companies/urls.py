...
urlpatterns = [
    path(
        "memberships/", MembershipListCreateAPIView.as_view(), name="memberships-list"
    ),
    path(
        "memberships/current/",
        MembershipCompanyListAPIView.as_view(),
        name="memberships-current",
    ),
    path(
        "memberships/current/<uuid:pk>/",
        MembershipCompanyDetailAPIView.as_view(),
        name="memberships-current-detail",
    ),
    path(
        "memberships/invite/",
        MembershipInviteAPIView.as_view(),
    ...
    path(
        ...
        name="invitations-list-create",
    ),
    path(
        "invitations/<uuid:pk>/<str:action>/",
        InvitationAcceptRejectAPIView.as_view(),
        name="invitations-accept-reject",
    ),
    path(
        "subscription/",
        SubscriptionActivationView.as_view(),
